...
parser.add_argument(
    "--notests", help="deactivate integration tests", action="store_true"
)
parser.add_argument(
    "--deploy", help="deploy python package to pip", action="store_true"
)
...
generator = gd.MarkdownAPIGenerator(
    "/lazycluster", "https://github.com/ml-tooling/lazycluster.git"
)
